...
class TestSeries(Base):
    ...
    is_result_show: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    is_score_show: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
